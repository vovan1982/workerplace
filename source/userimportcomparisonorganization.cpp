...
UserImportComparisonOrganization::UserImportComparisonOrganization(QWidget *parent, const QString &reportFile, const QMap<QString,QVariant> comparisonOrganization) :
    QDialog(parent),
    comparison(comparisonOrganization)
{
    setupUi(this);
    ...
    if(comparison.isEmpty()){
        ...
        for(int i = 0; i < handler.attrValues().count(); i++){
            ...
            populateCBox("id","departments","firm = 1",tr("<Выберите фирму>"),w2);
            connect(w2,SIGNAL(currentIndexChanged(int)),this,SLOT(setComparisonOrganization(int)));
...
void UserImportComparisonOrganization::changeEvent(QEvent *e)
{
...
void UserImportComparisonOrganization::populateCBox(const QString &idName, const QString &tableName,
...
void UserImportComparisonOrganization::setComparisonOrganization(int index)
{
...
void UserImportComparisonOrganization::on_buttonApplay_clicked()
{
